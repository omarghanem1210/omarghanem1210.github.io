...
Quiet the strange definition. He clarifies it by saying that, in so much as the ruler of a city is always the strongest, and that all laws set by such rulers are to their own advantage, it's just for the citizens to follow these laws.
